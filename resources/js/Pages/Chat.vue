        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg flex" style="min-height: 400px; max-height: 400px;">
                    ...
                    <!-- list users -->
                    <div class="w-3/12 bg-gray-200 bg-opacity-25 border-r border-r border-gray-200 overflow-y-scroll">
                        <ul>
                        ...
                        <div class="w-full p-6 flex flex-col overflow-y-scroll">
                            <div
                                ...
                                <p
                                    ...
                                    class="inline-block p-2 rounded-md bg-indigo-300 bg-opacity-25" style="max-width: 75%;">
                                    {{ message.content }}
                                </p>
